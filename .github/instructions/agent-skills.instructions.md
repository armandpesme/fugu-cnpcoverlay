...
|----------|-------|----------------|
| `.agents/skills/<skill-name>/` | Project/repository | Recommended active location for this template |
| `.github/skills/<skill-name>/` | Project/repository | Supported by VS Code, but disabled in this template to avoid duplicate discovery |
