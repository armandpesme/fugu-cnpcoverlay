---
description: 'Guidelines for building safe, governed AI agent systems. Apply when writing code that uses agent frameworks, tool-calling LLMs, MCP servers, hooks, custom agents, or multi-agent orchestration.'
applyTo: '**/*.agent.md,**/agents/**,**/hooks/**,**/mcp.json,**/.codex/config.toml,**/skills/**/SKILL.md'
---
