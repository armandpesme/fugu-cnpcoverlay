...
This project is indexed by GitNexus as **fugu-cnpcoverlay-3.0.1-alpha** (1287 symbols, 3127 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
