...
This project is indexed by GitNexus as **fugu-cnpcoverlay-3.0.1-alpha** (1285 symbols, 3125 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
