...
This project is indexed by GitNexus as **fugu-cnpcoverlay-3.0.1-alpha** (1229 symbols, 3019 relationships, 105 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
