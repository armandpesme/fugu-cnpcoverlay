...
This project is indexed by GitNexus as **fugu-cnpcoverlay** (727 symbols, 1568 relationships, 61 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/fugu-cnpcoverlay/context` | Codebase overview, check index freshness |
| `gitnexus://repo/fugu-cnpcoverlay/clusters` | All functional areas |
| `gitnexus://repo/fugu-cnpcoverlay/processes` | All execution flows |
| `gitnexus://repo/fugu-cnpcoverlay/process/{name}` | Step-by-step execution trace |
